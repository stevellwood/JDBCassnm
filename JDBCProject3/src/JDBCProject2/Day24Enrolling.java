...
//                myRs = pStmt.executeQuery();
        ...
        public Day24Enrolling() throws SQLException{
            Student st = new Student();//this fill the arraylist
...
//                pStmt.executeUpdate();
    ...
    //this        
            int major_id = evalMajor(stud.major,stud.sat);
              System.out.println(major_id+" is the majorid for "+stud.getFullName());  
            stud.setMajor_id(major_id);
            if(major_id == -1 || major_id == -2) {//problems
                ...
                pStmt.setInt(5,  major_id);//we got this from evalMajor
